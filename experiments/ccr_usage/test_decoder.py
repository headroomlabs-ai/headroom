...
'''
        self.assertEqual(read_usage(raw, 'text/event-stream'), dict(input_tokens=11, output_tokens=7, cache_read_input_tokens=13, cache_creation_input_tokens=17))
    ...
    def test_json_preserves_separate_cache_buckets(self):
        ...
        self.assertEqual(read_usage(raw, 'application/json'), dict(input_tokens=33, output_tokens=21, cache_read_input_tokens=39, cache_creation_input_tokens=51))
