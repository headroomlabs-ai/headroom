...
| `headroom diff` | Show original vs compressed content for recent requests | **native in container** |
...
`diff` queries the running proxy's loopback `/transformations/feed` endpoint,
