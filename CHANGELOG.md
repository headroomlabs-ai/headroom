...
* **wrap:** add `headroom wrap pi`, launching Pi with a transient provider extension that routes Pi's built-in Anthropic, Google Gemini/Vertex, OpenAI, and OpenAI Codex providers through the local Headroom proxy.
