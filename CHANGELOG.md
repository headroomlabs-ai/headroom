...
* **wrap (copilot):** add `headroom unwrap copilot` to remove Headroom's marker-fenced RTK guidance while preserving user instructions, with optional local proxy shutdown ([#1172](https://github.com/chopratejas/headroom/issues/1172)).
