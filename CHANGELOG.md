...
* **ccr:** accept SmartCrusher 12-char `<<ccr:HASH>>` markers in `CCRToolInjector` and `parse_tool_call`, fixing `/v1/retrieve/tool_call` rejections and missed tool injection ([#1095](https://github.com/chopratejas/headroom/issues/1095)).
