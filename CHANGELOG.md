...
* **codex:** `headroom unwrap codex` now removes the Headroom RTK instruction block from `$CODEX_HOME/AGENTS.md`, so Codex no longer keeps prefixing shell commands with `rtk` after unwrapping (#1421).
