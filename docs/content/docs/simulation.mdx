...
configs = [
    SmartCrusherConfig(min_tokens_to_crush=200),
    SmartCrusherConfig(min_tokens_to_crush=1000),
    SmartCrusherConfig(min_tokens_to_crush=5000),
]
...
for smart_crusher_config in configs:
    ...
    print(f"min_tokens={smart_crusher_config.min_tokens_to_crush}: "
