...
- `query` (optional) -- context hint for the concrete gap, recorded for feedback and stats. Retrieval still returns the full original content.

**Returns:**
- `original_content` with the full original payload
