...
Headroom uses release channels to keep new behavior out of stable installs until
it has baked through the right path.
...
See [Release Channels](/docs/release-channels) for the rollout policy and
contributor rules.
