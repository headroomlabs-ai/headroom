...
| `--factory-api-url` | None | Factory upstream for the Droid passthrough. Compresses the Anthropic-shaped `/api/llm/a/v1/messages` inference route and forwards every other Factory REST path verbatim (see [Factory Droid](/docs/droid)) |
